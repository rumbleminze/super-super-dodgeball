...
.byte $90, $09, $A5, $43
  ...
  ; ORA #$20
  ORA #$00 ; this disables sprite flickering

.byte $85, $43, $4C, $5F, $C1, $A0, $37, $B1, $4D, $99
...
.byte $06, $29, $01, $F0, $06, $A5, $43

  ; ORA #$20
  ORA #$00 ; this disables sprite flickering

.byte $85, $43, $A5, $90, $20, $2D, $E3
...
LDA MSU_700_OVERWRITE
BEQ :+
  STA $700
  LDA MSU_701_OVERWRITE
  STA $701 
:
